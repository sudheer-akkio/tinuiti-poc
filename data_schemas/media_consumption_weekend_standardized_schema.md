# Table Name: MEDIA_CONSUMPTION_WEEKEND_STANDARDIZED

## Table Description
Standardized proportions of weekend media consumption by channel, showing for each channel the share of users in five daily usage bands (don’t use, <1h, 1–3h, 3–5h, >5h); numeric columns are channel-level proportions that sum to ~1. This behavioral table supports weekend media planning, targeting, and audience segmentation for campaign and reach analysis. | :ui-name:Weekend Media Consumption :short-name:media_cons_weekend |<
